...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Jenis Organisasi Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Data Dasar</a></li>
                        <li class="breadcrumb-item active">Jenis Organisasi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        $(function() {
            ...
            $('body').on('click', '.editData', function() {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function(data) {
                        $('#modelHeading').html("Edit Jenis Organisasi");
