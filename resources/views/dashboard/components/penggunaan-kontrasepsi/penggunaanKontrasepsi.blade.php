...
@section('container')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Penggunaan Kontrasepsi Page
        </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                {{-- <li class="breadcrumb-item"><a href="/dashboard">Data Jenis Organisasi</a></li> --}}
                <li class="breadcrumb-item active" aria-current="page">Penggunaan Kontrasepsi</li>
            </ol>
        </nav>
    </div>
    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="id_kontrasepsi" name="id_kontrasepsi">
                                            ...
                                            @foreach ($alatKontrasepsi as $data)
                                                <option value="{{ $data->id_kontrasepsi }}">{{ $data->nama_kontrasepsi }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
