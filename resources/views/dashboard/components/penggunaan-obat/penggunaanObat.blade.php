...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pengunaan Obat Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Data Master</a></li>
                        <li class="breadcrumb-item active">Pengunaan Obat</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formData" name="formData">
                        <input type="hidden" name="id_penggunaan_obat" id="id_penggunaan_obat">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Obat Paten</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="obat_paten" name="obat_paten"
                                            required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Obat Generik</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="obat_generik" name="obat_generik"
                                            required />
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('penggunaan-obat.index') }}",
            ...
            $('#addBtn').click(function() {
                ...
                $('#modelHeading').html("Create New Data Penggunaan Obat");
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    url: "{{ route('penggunaan-obat.store') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
            ...
            $('body').on('click', '.editData', function() {
                var id_penggunaan_obat = $(this).data('id_penggunaan_obat');
                $.ajax({
                    type: "POST",
                    url: "{{ route('penggunaan-obat.edit') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id_penggunaan_obat: id_penggunaan_obat
                    },
                    dataType: 'json',
                    success: function(data) {
                        $('#modelHeading').html("Edit Penggunaan Obat");
                        $('#saveBtn').val("edit-data");
                        $('#formModel').modal('show');
                        $('#id_penggunaan_obat').val(data.id_penggunaan_obat);
                        $('#id_tahun').val(data.id_tahun);
                        $('#obat_paten').val(data.obat_paten);
                        $('#obat_generik').val(data.obat_generik);
                        if (data.defunct_ind == "Y") {
