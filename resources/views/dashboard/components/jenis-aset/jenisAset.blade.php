            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formData" name="formData">
                        <input type="hidden" name="id_jenis_aset" id="id_jenis_aset">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
    ...
    <script>
        $(function() {
            ...
            $('#addBtn').click(function() {
                ...
                $('#modelHeading').html("Create New Data Jenis Aset");
