...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Spesialis Dokter Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Data Dasar</a></li>
                        <li class="breadcrumb-item active">Spesialis Dokter</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <script>
        $(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('spesialis-dokter.index') }}",
            ...
            $('#addBtn').click(function() {
                ...
                $('#modelHeading').html("Create New Data Spesialis Dokter");
            ...
            $('body').on('click', '.editData', function() {
                var id_spesialis = $(this).data('id_spesialis');
                $.ajax({
                    type: "POST",
                    url: "{{ route('spesialis-dokter.edit') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id_spesialis: id_spesialis
                    },
                    dataType: 'json',
                    success: function(data) {
                        $('#modelHeading').html("Edit Spesialis Dokter");
