...
@section('container')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Status Dalam Keluarga Page
        </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                {{-- <li class="breadcrumb-item"><a href="/dashboard">Data Dasar</a></li> --}}
                <li class="breadcrumb-item active" aria-current="page">Status Dalam Keluarga</li>
            </ol>
        </nav>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="status_dalamkeluarga" name="status_dalamkeluarga"
                                            required />
                                    </div>
                                </div>
                            </div>
