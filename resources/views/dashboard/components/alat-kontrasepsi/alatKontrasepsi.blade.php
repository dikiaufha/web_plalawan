...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Alat Kontrasepsi Page</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">Data Dasar</a></li>
                        <li class="breadcrumb-item active">Alat Kontrasepsi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formData" name="formData">
                        <input type="hidden" name="id_kontrasepsi" id="id_kontrasepsi">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Nama Alat Kontrasepsi</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="nama_kontrasepsi"
                                            name="nama_kontrasepsi" required />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
    ...
    <script>
        $(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('alat-kontrasepsi.index') }}",
            ...
            $('#addBtn').click(function() {
                ...
                $('#modelHeading').html("Create New Data Alat Kontrasepsi");
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    url: "{{ route('alat-kontrasepsi.store') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
            ...
            $('body').on('click', '.editData', function() {
                var id_kontrasepsi = $(this).data('id_kontrasepsi');
                $.ajax({
                    type: "POST",
                    url: "{{ route('alat-kontrasepsi.edit') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id_kontrasepsi: id_kontrasepsi
                    },
                    dataType: 'json',
                    success: function(data) {
                        $('#modelHeading').html("Edit Alat Kontrasepsi");
                        $('#saveBtn').val("edit-data");
                        $('#formModel').modal('show');
                        $('#id_kontrasepsi').val(data.id_kontrasepsi);
                        $('#nama_kontrasepsi').val(data.nama_kontrasepsi);
                        if (data.defunct_ind == "Y") {
